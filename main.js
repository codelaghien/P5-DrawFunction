...
function setup() {
	...
	// canvas.style('transition', 'ease-in-out 1s');
...
function drawAll() {
	...
	document.getElementById('sketchHolder').style.visibility = 'visible';
	document.getElementById('sketchHolder').style.opacity = '1';
	document.getElementById('sketchHolder').style.transition = '0.75s ease-in';
	drawAxis();
	...
	myTimeout = setTimeout(function () {
		// canvas.style('height', '0px');
		document.getElementById('sketchHolder').style.visibility = 'hidden';
		document.getElementById('sketchHolder').style.opacity = '0';
		document.getElementById('sketchHolder').style.transition =
			'visibility 1s linear 0s, opacity 300ms;';
